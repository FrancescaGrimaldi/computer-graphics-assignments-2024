...
***************/
	...
	// house
	A->Triangle(-0.4, 0.5, 0.4, 0.5, -0.4, -0.2, 0.6,0.22,0.78);
	A->Triangle(-0.4, -0.2, 0.4, 0.5, 0.4, -0.2, 0.6,0.22,0.78);

	// house roof
	A->Triangle(0.4, -0.2, 0, -0.5, -0.4, -0.2, 0.6,0.22,0.78);

	// roof lines
	A->Line(0, -0.5, 0.4, -0.2, 0,0,0);
	A->Line(0, -0.5, -0.4, -0.2, 0,0,0);
